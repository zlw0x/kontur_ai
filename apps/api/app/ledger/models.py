...
class ResourceEventRow(Base):
    ...
    observed_model: Mapped[str | None] = mapped_column(String(100))
    requested_reasoning_effort: Mapped[str | None] = mapped_column(String(16))
    observed_reasoning_effort: Mapped[str | None] = mapped_column(String(16))
    model_observation_status: Mapped[str | None] = mapped_column(String(32))
    routing_profile_version: Mapped[str | None] = mapped_column(String(50))
    routing_rule_id: Mapped[str | None] = mapped_column(String(100))
    prompt_bundle_sha256: Mapped[str | None] = mapped_column(String(64))
