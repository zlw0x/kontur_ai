...
#: The two files whose subject *is* the naming convention, and which therefore have to
#: be able to write it down. Both derive the version; neither hard-codes one.
ALLOWED = {
